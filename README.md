# VR Evacuation Trainer Inclusivo
...
Simulador VR de evacuación de emergencias con accesibilidad para personas con discapacidad motora.

| Campo | Detalle |
|-------|---------|
| **Tipo XR** | VR |
| **Motor** | Unity 2022.3.62f1 |
| **Tecnología principal** | Google Cardboard XR Plugin + XR Interaction Toolkit |
...
- AR Foundation 5.1.x
- Google Cardboard XR Plugin + XR Interaction Toolkit

### Clonar el repositorio

```bash
git clone https://github.com/RubenCarty/rva-g01-evacuation-trainer.git
cd rva-g01-evacuation-trainer
```
